...
namespace BluedIT.Migrations
{
    ...
    [Migration("20200811182725_Added model for (Comments,Groups and Posts) and the respective controller for them.")]
    partial class AddedmodelforCommentsGroupsandPostsandtherespectivecontrollerforthem
    {
